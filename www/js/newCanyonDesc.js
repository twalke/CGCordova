...
document.getElementById("back").setAttribute("href", `newCanyonDetails.html?${canyonTitle}?${areaTitle}`);
document.getElementById("next").setAttribute("href", `newCanyonGps.html?${canyonTitle}?${areaTitle}`);
