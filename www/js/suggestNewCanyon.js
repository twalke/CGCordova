...
document.getElementById("back").setAttribute("href", `canyonList.html?${canyonTitle}?${areaTitle}`);
document.getElementById("next").setAttribute("href", `newCanyonDetails.html?${canyonTitle}?${areaTitle}`);
