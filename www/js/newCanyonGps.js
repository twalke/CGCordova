...
document.getElementById("back").setAttribute("href", `newCanyonDesc.html?${canyonTitle}?${areaTitle}`);
document.getElementById("next").setAttribute("href", `newCanyonFinalCheck.html?${canyonTitle}?${areaTitle}`);
